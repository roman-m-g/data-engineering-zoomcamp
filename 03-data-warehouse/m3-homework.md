...
```
select count (*)
from gcp_de_project.gcp_bq_dataset.external_yellow_tripdata
```
...
select count (distinct PULocationID)
from gcp_de_project.gcp_bq_dataset.yellow_tripdata
```
...
```
CREATE TABLE gcp_de_project.gcp_bq_dataset.optimized_yellow_tripdata
